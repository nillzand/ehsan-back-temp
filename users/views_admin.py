...
class AllocateBudgetView(APIView):
    ...
    def post(self, request, user_id, *args, **kwargs):
        ...
        if company_wallet.balance < amount_to_allocate:
            return Response(
                {"error": "موجودی کیف پول شرکت برای انجام این تراکنش کافی نیست."},
        ...
        Transaction.objects.create(
            ...
            description=f"اعتبار تخصیص داده شده توسط {request.user.username}."
        )
        
        return Response(
            {
                "message": "اعتبار با موفقیت تخصیص داده شد.",
