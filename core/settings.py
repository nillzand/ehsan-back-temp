...
INSTALLED_APPS = [
    ...
    'core', 'users', 'companies', 'menu', 'schedules', 'orders',
    'wallets', 'contracts', 'surveys', 'discounts',
]
MIDDLEWARE = [
...
# ... (بخش دیتابیس بدون تغییر باقی می‌ماند)
...
if DB_HOST and DB_NAME and DB_USER and DB_PASS and DB_PORT:
    DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql','NAME': DB_NAME,'USER': DB_USER,'PASSWORD': DB_PASS,'HOST': DB_HOST,'PORT': DB_PORT,}}
elif DATABASE_URL:
...
LOGGING = {
    ...
    'formatters': {'verbose': {'format': '{levelname} {asctime} {module} {process:d} {thread:d} {message}', 'style': '{',}, 'simple': {'format': '{levelname} {message}', 'style': '{',},},
